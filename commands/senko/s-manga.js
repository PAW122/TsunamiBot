...
async function buttons(interaction) {
    if (interaction.customId !== 's-manga:manga_previous' && interaction.customId !== 's-manga:manga_next' && interaction.customId !== 's-manga:manga_next_chapter' && interaction.customId !== 's-manga:manga_prev_chapter') return;
    ...
    if (interaction.customId === 's-manga:manga_next_chapter') {
    ...
    } else if (interaction.customId === 's-manga:manga_prev_chapter') {
    ...
    if (interaction.customId === 's-manga:manga_previous') {
        if (page === 0) return;
        page--;
    } else if (interaction.customId === 's-manga:manga_next') {
    ...
    await interaction.update({
        ...
        components: [
            new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
                        .setCustomId(page === 0 ? 's-manga:manga_prev_chapter' : 's-manga:manga_previous')
                    ...
                    new ButtonBuilder()
                        .setCustomId('s-manga:manga_page')
                        .setLabel(`${page + 1} / ${images.length}`)
                        .setStyle('Success')
                        .setDisabled(true),
                    new ButtonBuilder()
                        .setCustomId(page === (images.length - 1) ? 's-manga:manga_next_chapter' : 's-manga:manga_next')
    ...
    await interaction.reply({
        ...
        components: [
            new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
                        .setCustomId('s-manga:manga_previous')
                        .setLabel('←')
                        .setStyle('Secondary')
                        .setDisabled(true),
                    new ButtonBuilder()
                        ...
                        .setDisabled(true),
                    new ButtonBuilder()
                        .setCustomId('s-manga:manga_next')
                        .setLabel('→')
                        .setStyle('Secondary')
                )
        ]
...
module.exports = { command, execute, help_message, autocomplete, buttons, init };
